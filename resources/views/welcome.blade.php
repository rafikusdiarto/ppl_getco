...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        ...
        <nav class="w-full flex justify-between bg-lime-700 px-10 py-4">
            <a href="{{ url('/') }}" class="flex gap-2 items-center h-full ml-10">
            ...
            <div class="flex items-center mr-10">
                ...
                @else
                <a class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-3 text-center mr-2 mb-2" href="{{ route('login') }}">
                    Log in
                </a>
                @if (Route::has('register'))
                <a class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800" href="{{ route('register') }}">
